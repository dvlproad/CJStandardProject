...
/// 更新照片并显示识别结果
- (void)__updatePhotoWithImage:(UIImage *)image recognizeResultModel:(RecognizeResultModel *)recognizeResultModel {
    _image = image;
...
- (UIButton *)photoImageButton {
    if (_photoImageButton == nil) {
        ...
        [_photoImageButton setBackgroundColor:[UIColor cjColorWithHexString:@"#F5F5F6"]];
...
- (UIButton *)reuploadButton {
    if (_reuploadButton == nil) {
        ...
        //[_reuploadButton setBackgroundColor:[UIColor cjColorWithHexString:@"#F5F5F6"]];
