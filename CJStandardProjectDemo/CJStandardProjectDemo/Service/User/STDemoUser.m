...
- (void)updatePortraitImageLocalRelativePathByChooseImage:(UIImage *)choosePortraitImage {
    NSString *relativeDirectory = [CJFileManager getLocalDirectoryPathType:CJLocalPathTypeRelative bySubDirectoryPath:@"STDemoUserImage" inSearchPathDirectory:NSDocumentDirectory createIfNoExist:YES];
...
- (BOOL)hasPermissionWithPermissionID:(DemoHPPermissionType)permissionID {
    for (STDemoUsePermissionModel *e in self.auths) {
